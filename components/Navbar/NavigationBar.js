...
function NavigationBar() {
  ...
  return (
    <div className=" bg-white  md:hidden   fixed w-full bottom-[0%] z-[1000] shadow-x4 shadow-gray-700 ">
      <div className="container flex justify-between py-2 sm:py-4  md:w-8/12 lg:w-6/12  items-center sm:justify-around px-6">
        <Link href="/">
        ...
        <Link href="/groups">
          <a className="text-white flex flex-col items-center sm:flex-row">
            ...
            <p className=" text-xs mt-1 text-green-400 sm:ml-2">Groups</p>
          </a>
        </Link>
        <Link href="/blog">
          <a className="text-white flex flex-col items-center sm:flex-row">
