      ...
      <div className="mt-3 w-full   md:w-[48%] lg:w-[32%] overflow-hidden shadow-md sm:rounded-md border-t-2  bg-white">
        ...
        <div className="p-4 cursor-pointer">
          <Link href="/blog/[id]" as={`/blog/${item.id}`}>
            <a className="text-2xl font-bold text-gray-700 transition-all hover:text-sky-300 cursor-pointer ">
              {item.info.title}
            </a>
          </Link>
          <h2 className="text-base text-sky-600 py-2">{item.info.des}</h2>
