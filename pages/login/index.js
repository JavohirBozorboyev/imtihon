  ...
  return (
    <div>
      <div className="flex flex-col  items-center justify-center">
        <div className="bg-white shadow-md rounded w-full sm:w-8/12 md:w-6/12 lg:w-4/12 p-6 mt-4 mb-16">
          <p className="focus:outline-none text-2xl font-extrabold leading-6 text-gray-700">
            ...
            <div className="mt-6  w-full">
              ...
              <div className="relative flex items-center justify-center">
                <input
                  ...
                  className="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2"
                />
                <div className="absolute right-0 mt-2 mr-3 cursor-pointer" onClick={openPas}>
                  <svg
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
